...
function maybeCaptureName(text) {
    ...
    if (emailMatch || phoneMatch) {
        ...
        fetch(SB_URL + '/rest/v1/client_leads', {
            ...
            body: JSON.stringify({ name: clientName, email: clientEmail, phone: clientPhone, brand: 'PRISCION', status: 'new' })
        }).catch(() => {});
    }
}
...
const STEPS = {
    ...
    "start": {
        ...
        "r": [
            { "l": "About PRISCION", "s": "about", "i": "info" },
    ...
    "about": {
        "bot": "PRISCION is an enterprise AI and digital transformation partner — we build high-fidelity web architecture, AI automation systems, and brand infrastructure for businesses ready to scale. Based in Trinidad & Tobago, working across the Caribbean.",
        "r": [
            { "l": "Evolve Mobility", "s": "about_brands", "i": "car" },
            { "l": "The Way Made Known", "s": "about_twmk", "i": "heart" },
            { "l": "About PRISCION", "s": "about_founder", "i": "user" },
    ...
    "about_founder": {
        "bot": "PRISCION was founded in Trinidad & Tobago by Priscilla Narine. The agency operates as an enterprise AI and digital transformation partner — combining high-fidelity web architecture with AI automation (chatbots, WhatsApp automation, voice agents, lead qualification) to help businesses modernize how they operate, not just how they look online.",
        "r": [
            { "l": "Back", "s": "about", "i": "arrow-left" }
        ]
    },
    ...
    "pkg_menu": {
        "bot": "Our agency packages are full custom builds — designed, developed and delivered by PRISCION. Which fits your needs?",
        "r": [
    ...
    "pkg_ai": {
        "bot": "AI Consultancy at PRISCION covers two things: AI Employees (department-based automation) and AI Voice (voice agents). Which one fits what you're trying to automate?",
        "r": [
            { "l": "AI Employees (9 departments)", "s": "aidata_products", "i": "database" },
            { "l": "AI Voice (receptionist, sales)", "s": "aivoice_products", "i": "phone" },
    ...
    function buildVoicePicker() {
        ...
        voices.forEach(function(v) {
            ...
            playBtn.onclick = function() {
                window.speechSynthesis.cancel();
                var u = new SpeechSynthesisUtterance("Hi! I'm the PRISCION assistant. This is what I sound like.");
